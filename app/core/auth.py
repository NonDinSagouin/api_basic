...
def create_auth_blueprint(redis_client):
    """Crée le blueprint pour les routes d'authentification"""
    ...
    def authentification():
        ...
        redis_client.setex(f"token_use:{jti}", int(expires.total_seconds()), params.TOKEN_RATE_LIMIT_PER_MINUTE)
